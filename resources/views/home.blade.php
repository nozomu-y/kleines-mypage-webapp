            ...
            <div class="col-xl-4 col-sm-6">
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">{{ __('message.looking_for_developers.title') }}
                        </h6>
                    </div>
                    <div class="card-body">
                        <p>
...
<div class="d-block d-md-none">
    ...
    <div class="card card-flush shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="mb-2">
                <a href="https://github.com/nozomu-y/kleines-mypage-webapp" target="_blank">
                    <img class="img-fluid" src="https://gh-card.dev/repos/nozomu-y/kleines-mypage-webapp.svg?fullname=">
                </a>
            </div>
            <div>
                <a href="https://github.com/nozomu-y/kleines-mypage-api" target="_blank">
                    <img class="img-fluid" src="https://gh-card.dev/repos/nozomu-y/kleines-mypage-api.svg?fullname=">
                </a>
            </div>
        </div>
    </div>
